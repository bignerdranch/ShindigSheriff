...
ActiveRecord::Schema.define(version: 20140120230223) do
  ...
  add_index "finance_approvers", ["user_id", "organization_id"], name: "index_finance_approvers_on_user_id_and_organization_id", unique: true, using: :btree
